!(function (A, e) {
        ...
        if (A) {
          ...
          if (!isNaN(A.length)) {
            var n = -1,
              a = function t() {
                for (; ++n < A.length; )
                  {if (r.call(A, n)) {return ((t.value = A[n]), (t.done = !1), t);}}
  ...
  function ht(A, e, t) {
    ...
    for (var o = A.slice(), g = 0; g < i; ++g)
      {for (var I = 0; I < t; ++I) {A[t * g + I] = o[(t - I - 1) * i + g];}}
  }
  ...
  function vt(A, e, t, r) {
    ...
    if (e !== nA.RATIONAL && e !== nA.SRATIONAL)
      {for (var o = 0; o < t; ++o) {n[o] = i.call(A, r + o * a);}}
    else
      {for (var g = 0; g < t; g += 2)
    ...
    for (var I = 0; I < n; I++) {
      ...
      for (var c = 0; c < r; c++) {
        ...
        for (var f = 0, C = c << 3, u = 0; u < 8; u++)
          {for (var Q = t[s + u], E = 0; E < 8; E++) {Q[C + E] = o[f++];}}
      }
    }
    return t;
  }
          ...
          var A = function (A, e, t, r, n, i, a, o) {
            ...
            a = {
                ...
                if (n.length === I * g)
                  ...
                  if (g > 1) {
                    if (r) {
                      for (u = 0; u < I; u++)
                        {if (c[u])
                          {for (E = u, Q = 0; Q < g; Q++, E += I) {e.pixels.resultPixels[E] = n[C++];}}}
                    } else
                      {for (u = 0; u < I; u++)
                        {if (c[u])
                          {for (E = u * g, Q = 0; Q < g; Q++) {e.pixels.resultPixels[E + Q] = n[C++];}}}}
              ...
              constructConstantSurface: function (A, e) {
                ...
                if (s)
                  {if (i > 1) {
                    if (e)
                      {for (o = 0; o < i; o++)
                        {for (I = o * a, t = n[o], g = 0; g < a; g++) {s[g] && (B[I + g] = t);}}}
                    else
                      {for (g = 0; g < a; g++)
                        {if (s[g]) {for (I = g * i, o = 0; o < i; o++) {B[I + i] = n[o];}}}}
                  } else {for (g = 0; g < a; g++) {s[g] && (B[g] = t);}}}
                else if (i > 1 && r !== t)
                  {if (e)
                    {for (o = 0; o < i; o++)
                      {for (I = o * a, t = n[o], g = 0; g < a; g++) {B[I + g] = t;}}}
              ...
              swapDimensionOrder: function (A, e, t, r, n) {
                ...
                if (t > 1)
                  {if (((I = new r(e * t)), n))
                    {for (i = 0; i < e; i++) {for (g = i, o = 0; o < t; o++, g += e) {I[g] = A[a++];}}}
          ...
          decode: function (A, e) {
            ...
            if (r > 1 && d > 1) {
              for (
                ...
                {for (g = l[f], C = 0; C < u; C++) {c[C] = c[C] & g[C];}}
              h.maskData = c;
            }
            return h;
          },
