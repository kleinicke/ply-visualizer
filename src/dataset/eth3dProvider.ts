...
import { extract7z } from './sevenZip';
...
export class Eth3dProvider implements DatasetProvider {
  ...
  private readonly scenes: DatasetScene[] = [
    {
      name: 'delivery_area_1l',
      displayName: 'Delivery Area 1L',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'delivery_area_1s',
      displayName: 'Delivery Area 1S',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'delivery_area_2l',
      displayName: 'Delivery Area 2L',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'delivery_area_2s',
      displayName: 'Delivery Area 2S',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'delivery_area_3l',
      displayName: 'Delivery Area 3L',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'delivery_area_3s',
      displayName: 'Delivery Area 3S',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'electro_1l',
      displayName: 'Electro 1L',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'electro_1s',
      displayName: 'Electro 1S',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'electro_2l',
      displayName: 'Electro 2L',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'electro_2s',
      displayName: 'Electro 2S',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'electro_3l',
      displayName: 'Electro 3L',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'electro_3s',
      displayName: 'Electro 3S',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'facade_1s',
      displayName: 'Facade 1S',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'forest_1s',
      displayName: 'Forest 1S',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'forest_2s',
      displayName: 'Forest 2S',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'playground_1l',
      displayName: 'Playground 1L',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'playground_1s',
      displayName: 'Playground 1S',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'playground_2l',
      displayName: 'Playground 2L',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'playground_2s',
      displayName: 'Playground 2S',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'playground_3l',
      displayName: 'Playground 3L',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'playground_3s',
      displayName: 'Playground 3S',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'terrace_1s',
      displayName: 'Terrace 1S',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'terrace_2s',
      displayName: 'Terrace 2S',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'terrains_1l',
      displayName: 'Terrains 1L',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'terrains_1s',
      displayName: 'Terrains 1S',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'terrains_2l',
      displayName: 'Terrains 2L',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
    {
      name: 'terrains_2s',
      displayName: 'Terrains 2S',
      cached: false,
      files: { calibration: 'calib.txt', disparity: 'disp0GT.pfm', image: 'im0.png' },
    },
  ];
  ...
  private async downloadAndExtractArchives(
    onProgress?: (progress: DownloadProgress) => void
  ): Promise<void> {
    ...
    await this.cleanupFiles([...archivePaths, tempDir1, tempDir2]);
  ...
  private async extract7zWithLibrary(archivePath: string, extractDir: string): Promise<void> {
    ...
    // One universal WASM build replaces the per-platform native binaries that
    // used to be copied into out/7zip-bin/, so there is no platform or
    // executable-bit handling left here. `7z-wasm` resolves its own .wasm
    // relative to the bundle, which webpack emits alongside extension.js.
