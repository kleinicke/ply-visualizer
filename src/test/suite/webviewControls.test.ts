...
class MockVector3 {
    ...
    copy(v: MockVector3): MockVector3 { this.x = v.x; this.y = v.y; this.z = v.z; return this; }
    set(x: number, y: number, z: number): MockVector3 { this.x = x; this.y = y; this.z = z; return this; }
    add(v: MockVector3): MockVector3 { this.x += v.x; this.y += v.y; this.z += v.z; return this; }
    sub(v: MockVector3): MockVector3 { this.x -= v.x; this.y -= v.y; this.z -= v.z; return this; }
    multiplyScalar(s: number): MockVector3 { this.x *= s; this.y *= s; this.z *= s; return this; }
    normalize(): MockVector3 { const l = this.length(); if (l > 0) { this.multiplyScalar(1 / l); } return this; }
    ...
    dot(v: MockVector3): number { return this.x * v.x + this.y * v.y + this.z * v.z; }
    distanceTo(v: MockVector3): number { return this.clone().sub(v).length(); }
    ...
    applyQuaternion(_q: any): MockVector3 { return this; }
    applyAxisAngle(_axis: MockVector3, _angle: number): MockVector3 { return this; }
    setLength(length: number): MockVector3 { return this.normalize().multiplyScalar(length); }
...
class MockVector2 {
    ...
    clone(): MockVector2 { return new MockVector2(this.x, this.y); }
    copy(v: MockVector2): MockVector2 { this.x = v.x; this.y = v.y; return this; }
    set(x: number, y: number): MockVector2 { this.x = x; this.y = y; return this; }
    length(): number { return Math.sqrt(this.x * this.x + this.y * this.y); }
    lengthSq(): number { return this.x * this.x + this.y * this.y; }
    normalize(): MockVector2 { const l = this.length(); if (l > 0) { this.x /= l; this.y /= l; } return this; }
}

class MockQuaternion {
    constructor() {}
    setFromAxisAngle(_axis: MockVector3, _angle: number): MockQuaternion { return this; }
    multiplyQuaternions(_a: MockQuaternion, _b: MockQuaternion): MockQuaternion { return this; }
    invert(): MockQuaternion { return this; }
}
