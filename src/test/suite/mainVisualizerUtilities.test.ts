...
suite('PointCloudVisualizer Utility Methods Test Suite', () => {
    ...
    suite('Color Utilities', () => {
        test('Should get color names by index', () => {
            const colors = [
                ...
                'orange', 'purple', 'brown', 'pink', 'gray', 'black'
            ];
    ...
    suite('File Size and Memory Utilities', () => {
        ...
        test('Should estimate memory usage for point clouds', () => {
            const estimateMemoryUsage = (vertexCount: number, hasColors: boolean, hasNormals: boolean): number => {
    ...
    suite('Status and Progress Utilities', () => {
        test('Should format progress messages', () => {
            ...
            assert.strictEqual(formatProgressMessage(500, 1000, 'Processing'), 'Processing: 500/1000 (50%)');
        ...
        test('Should validate processing status', () => {
            ...
            const validateStatus = (status: string): status is ProcessingStatus => {
                const validStatuses: ProcessingStatus[] = ['idle', 'loading', 'processing', 'complete', 'error'];
    ...
    suite('UI State Management Utilities', () => {
        test('Should manage button states', () => {
            ...
            const updateButtonState = (button: ButtonState, active: boolean, disabled?: boolean): ButtonState => {
                return {
                    ...button,
                    active,
            ...
            const axesButton: ButtonState = { id: 'axes', active: false, disabled: false, text: 'Show axes' };
