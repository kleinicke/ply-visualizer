...
suite('PointCloudVisualizer Core Methods Test Suite', () => {
    ...
    suite('Camera Controls', () => {
        test('Should handle camera control type switching', () => {
            ...
            const validTypes: ControlType[] = ['trackball', 'orbit', 'inverse-trackball', 'arcball', 'cloudcompare'];
    ...
    suite('Error Handling', () => {
        ...
        test('Should handle empty or invalid file data', () => {
            const emptyData = { vertices: [], faces: [], vertexCount: 0, faceCount: 0, hasColors: false, hasNormals: false };
