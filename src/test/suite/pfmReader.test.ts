...
suite('PfmReader', () => {
  ...
  suite('read', () => {
    function createPfmBuffer(
      ...
      // Write header
      let offset = 0;
      view.set(headerBuffer, offset);
      offset += headerBuffer.length;
      view.set(dimsBuffer, offset);
      offset += dimsBuffer.length;
      view.set(scaleBuffer, offset);
      offset += scaleBuffer.length;
    ...
    test('should throw error for invalid dimensions', async () => {
      ...
      view.set(headerBuffer, offset);
      offset += headerBuffer.length;
      view.set(invalidDimsBuffer, offset);
      offset += invalidDimsBuffer.length;
      view.set(scaleBuffer, offset);
