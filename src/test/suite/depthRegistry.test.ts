...
import { registerReader, registerDefaultReaders, findReader, readDepth, clearReaders } from '../../webview/depth/DepthRegistry';
import { DepthReader, DepthReaderResult, DepthImage, DepthMetadata } from '../../webview/depth/types';
...
suite('DepthRegistry', () => {
    ...
    suite('registerDefaultReaders', () => {
        test('should register default readers without error', () => {
            ...
            const mockReaders = {
                PfmReader: class { canRead() { return false; } async read() { throw new Error('Mock'); } },
                TifReader: class { canRead() { return false; } async read() { throw new Error('Mock'); } },
                NpyReader: class { canRead() { return false; } async read() { throw new Error('Mock'); } },
                PngReader: class { canRead() { return false; } async read() { throw new Error('Mock'); } },
                ExrReader: class { canRead() { return false; } async read() { throw new Error('Mock'); } }
            };
