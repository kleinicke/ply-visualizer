...
export class YamlCalibrationParser {
    ...
    private static parseOpenCVFormat(data: any, fileName: string): YamlCalibrationResult {
        ...
        const distortion = data.distortion_coefficients ? this.parseOpenCVMatrix(data.distortion_coefficients) : null;
    ...
    private static parseStereoFormat(data: any, fileName: string): YamlCalibrationResult {
        ...
        if (data.left_camera_matrix) {
            ...
            const leftDistortion = data.left_distortion ? this.parseOpenCVMatrix(data.left_distortion) : null;
        ...
        if (data.right_camera_matrix) {
            ...
            const rightDistortion = data.right_distortion ? this.parseOpenCVMatrix(data.right_distortion) : null;
