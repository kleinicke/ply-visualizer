...
>
  ...
  >
    ...
    <div style="margin-bottom: 20px;">
      ...
      <div style="font-size: 10px; color: var(--vscode-descriptionForeground); margin-top: 3px;">Pinhole: k1,k2,p1,p2,k3,k4,k5,k6,s1,s2,s3,s4,tauX,tauY · Fisheye: k0..k5,p0,p1,s0..s3 — OpenCV fisheye k1..k4 and Kannala-Brandt k0..k3 are the first four of these</div>
    </div>
