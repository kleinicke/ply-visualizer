...
(function () {
   ...
   */
  __exports.project_depth_fast = function (
    data,
    width,
    height,
    kind,
   ...
   * @returns {JpegResult}
   */
  __exports.decode_jpeg_fast = function (data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
   ...
   */
  __exports.camera_project_points_indexed = function (
    camera_model,
    fx,
    fy,
    cx,
   ...
   * @returns {TiffResult}
   */
  __exports.decode_tiff_page = function (data, page_index) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
   ...
   * @returns {TiffResult}
   */
  __exports.decode_tiff = function (data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
   ...
   * @returns {TiffResult}
   */
  __exports.decode_tiff_page_fast = function (data, page_index) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
   ...
   * @returns {DepthProjectResult}
   */
  __exports.project_depth_band = function (
    data,
    width,
    height,
    row_offset,
   ...
   * @returns {number}
   */
  __exports.tiff_page_count = function (data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
   ...
   * @returns {string}
   */
  __exports.extract_exif_tags = function (data) {
    let deferred2_0;
    let deferred2_1;
    try {
      const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
  ...
  __exports.JpegResult = JpegResult;
  ...
  __exports.TiffResult = TiffResult;
