!(function (A, e) {
  'object' === typeof exports && 'undefined' !== typeof module
    ...
    : 'function' === typeof define && define.amd
      ? define(['exports'], e)
      : e(((A = 'undefined' !== typeof globalThis ? globalThis : A || self).GeoTIFF = {}));
})(this, function (A) {
  'use strict';
  function e(A, e, t) {
    return (
      ...
      (function (A, e) {
        ...
        if (null != t) {
          ...
          try {
            for (
              t = t.call(A);
              !(a = (r = t.next()).done) && (i.push(r.value), !e || i.length !== e);
              a = !0
            ) {}
          } catch (A) {
            ((o = !0), (n = A));
  ...
  function h(A) {
    ...
    return (
      (h = function (A) {
        if (null === A || ((t = A), -1 === Function.toString.call(t).indexOf('[native code]'))) {
          return A;
        }
        var t;
      ...
      function m(A, t) {
        ...
        if (r === e) {
          if (((t.delegate = null), 'throw' === t.method)) {
            if (
              A.iterator.return &&
              ((t.method = 'return'), (t.arg = e), m(A, t), 'throw' === t.method)
            ) {
              return Q;
            }
            ((t.method = 'throw'),
        ...
        if ('throw' === n.type) {
          return ((t.method = 'throw'), (t.arg = n.arg), (t.delegate = null), Q);
        }
        var i = n.arg;
        return i
          ? i.done
        ...
        (A.mark = function (A) {
          return (
            Object.setPrototypeOf
              ...
              : ((A.__proto__ = h), g(A, o, 'GeneratorFunction')),
        ...
        (G.prototype = {
          ...
          abrupt: function (A, e) {
            ...
            return (
              (a.type = A),
              (a.arg = e),
              i ? ((this.method = 'next'), (this.next = i.finallyLoc), Q) : this.complete(a)
            );
          },
          ...
          delegateYield: function (A, t, r) {
            return (
              (this.delegate = { iterator: S(A), resultName: t, nextLoc: r }),
  ...
  for (
    ...
    F < -27
      ...
      : F < -14
        ? ((b[S] = 1024 >> (-F - 14)),
          (b[256 | S] = (1024 >> (-F - 14)) | 32768),
          (G[S] = -F - 1),
          (G[256 | S] = -F - 1))
        : F <= 15
          ? ((b[S] = (F + 15) << 10),
            (b[256 | S] = ((F + 15) << 10) | 32768),
            (G[S] = 13),
            (G[256 | S] = 13))
          : F < 128
  ...
  for (var L = 1; L < 1024; ++L) {
    for (var M = L << 13, N = 0; 0 == (8388608 & M); ) {
      ((N -= 8388608), (M <<= 1));
    }
    ((M &= -8388609), (N += 947912704), (R[L] = M | N));
  }
  for (var q = 1024; q < 2048; ++q) {
    R[q] = 939524096 + ((q - 1024) << 13);
  }
  x[0] = 0;
  for (var J = 1; J < 31; ++J) {
    x[J] = J << 23;
  ...
  var W = function (A, e, t) {
    ...
    if ((r && console.log('start:', i), -1 !== i)) {
      ...
      if ((r && console.log('end:', I), -1 !== I)) {
        var s = A.slice(i, I);
        return {
          inner: g ? null : s.slice(s.indexOf('>') + 1, s.lastIndexOf('<')),
          outer: s,
          start: i,
          end: I,
        };
  ...
  var Z = function (A, e, t) {
      for (
        var r, n = [], i = (t && t.debug) || !1, a = (t && t.startIndex) || 0;
        (r = W(A, e, { debug: i, startIndex: a }));
      ) {
        ((a = r.end), n.push(r));
      }
    ...
    $ = {};
  for (var AA in z) {
    z.hasOwnProperty(AA) && ($[z[AA]] = parseInt(AA, 10));
  }
  var eA = {
      256: 'SHORT',
      257: 'SHORT',
    ...
    nA = {};
  for (var iA in rA) {
    rA.hasOwnProperty(iA) && (nA[rA[iA]] = parseInt(iA, 10));
  }
  var aA = {
      WhiteIsZero: 0,
      BlackIsZero: 1,
    ...
    BA = {};
  for (var cA in sA) {
    sA.hasOwnProperty(cA) && (BA[sA[cA]] = parseInt(cA, 10));
  }
  var fA = Object.freeze({
    ...
    fieldTypeNames: rA,
    fieldTypes: nA,
    photometricInterpretations: aA,
    ExtraSamplesValues: oA,
    LercParameters: gA,
    LercAddCompression: IA,
    geoKeyNames: sA,
    geoKeys: BA,
  });
  function CA(A, e) {
    for (
      var t, r = A.width, n = A.height, i = new Uint8Array(r * n * 3), a = 0, o = 0;
      a < A.length;
      ++a, o += 3
    ) {
      ((t = 256 - (A[a] / e) * 256), (i[o] = t), (i[o + 1] = t), (i[o + 2] = t));
    }
    return i;
  }
  function uA(A, e) {
    for (
      ...
      ((t = (A[a] / e) * 256), (i[o] = t), (i[o + 1] = t), (i[o + 2] = t));
    }
    return i;
  }
  function QA(A, e) {
    for (
      ...
      var I = A[o];
      ((n[g] = (e[I] / 65536) * 256),
        (n[g + 1] = (e[I + i] / 65536) * 256),
        (n[g + 2] = (e[I + a] / 65536) * 256));
    }
    return n;
  }
  function EA(A) {
    for (
      var e = A.width, t = A.height, r = new Uint8Array(e * t * 3), n = 0, i = 0;
      n < A.length;
      n += 4, i += 3
    ) {
      var a = A[n],
        ...
        g = A[n + 2],
        I = A[n + 3];
      ((r[i] = ((255 - a) / 256) * 255 * ((255 - I) / 256)),
        (r[i + 1] = ((255 - o) / 256) * 255 * ((255 - I) / 256)),
        (r[i + 2] = ((255 - g) / 256) * 255 * ((255 - I) / 256)));
    }
    return r;
  }
  function lA(A) {
    for (
      var e = A.width, t = A.height, r = new Uint8ClampedArray(e * t * 3), n = 0, i = 0;
      n < A.length;
      n += 3, i += 3
    ) {
      var a = A[n],
        ...
        g = A[n + 2];
      ((r[i] = a + 1.402 * (g - 128)),
        (r[i + 1] = a - 0.34414 * (o - 128) - 0.71414 * (g - 128)),
        (r[i + 2] = a + 1.772 * (o - 128)));
    }
    return r;
  }
  function hA(A) {
    for (
      ...
      var a = (A[n + 0] + 16) / 116,
        ...
        B = void 0;
      ((s =
        -0.9689 * (o = 0.95047 * (o * o * o > 0.008856 ? o * o * o : (o - 16 / 116) / 7.787)) +
        1.8758 * (a = 1 * (a * a * a > 0.008856 ? a * a * a : (a - 16 / 116) / 7.787)) +
        0.0415 * (g = 1.08883 * (g * g * g > 0.008856 ? g * g * g : (g - 16 / 116) / 7.787))),
        (B = 0.0557 * o + -0.204 * a + 1.057 * g),
        (I =
          (I = 3.2406 * o + -1.5372 * a + -0.4986 * g) > 0.0031308
  ...
  function bA(A, e, t, r, n) {
    ...
    return A.map(function (A) {
      for (var o = kA(A, r, n), g = 0; g < n; ++g) {
        for (
          var I = a * g, s = Math.floor(I), B = Math.min(Math.ceil(I), t - 1), c = 0;
          c < r;
          ++c
        ) {
          var f = i * c,
  ...
  function FA(A, e, t, r, n, i) {
    for (var a = e / r, o = t / n, g = kA(A, r, n, i), I = 0; I < n; ++I) {
      for (var s = o * I, B = Math.floor(s), c = Math.min(Math.ceil(s), t - 1), f = 0; f < r; ++f) {
        for (
          var C = a * f, u = C % 1, Q = Math.floor(C), E = Math.min(Math.ceil(C), e - 1), l = 0;
          l < i;
          ++l
        ) {
          var h = A[B * e * i + Q * i + l],
        ...
        for (var f = c * B, C = 0; C < i; ++C) {
          for (var u = f + C * g * n, Q = 0; Q < g; ++Q) {
            var E = u + Q * n,
              ...
              d = E % 8;
            if (d + n <= 8) {
              I[l] = (o.getUint8(h) >> (8 - n - d)) & s;
            } else if (d + n <= 16) {
              I[l] = (o.getUint16(h) >> (16 - n - d)) & s;
            } else if (d + n <= 24) {
              var w = (o.getUint16(h) << 8) | o.getUint8(h + 2);
              I[l] = (w >> (24 - n - d)) & s;
            } else {
              I[l] = (o.getUint32(h) >> (32 - n - d)) & s;
            }
          }
        }
      }
  ...
  var NA = (function () {
      function A(e, t, r, n, i, a) {
        ...
        if (
          ((this.planarConfiguration = void 0 === o ? 1 : o),
      ...
      return (
        s(A, [
          ...
          },
          {
            ...
            value: function () {
              return void 0 !== this.fileDirectory.SamplesPerPixel
          ...
          },
          {
            key: 'getBlockHeight',
            value: function (A) {
              return this.isTiled || (A + 1) * this.getTileHeight() <= this.getHeight()
                ? this.getTileHeight()
                : this.getHeight() - A * this.getTileHeight();
            },
          },
          {
            key: 'getBytesPerPixel',
            value: function () {
              for (var A = 0, e = 0; e < this.fileDirectory.BitsPerSample.length; ++e) {
          ...
          },
          {
            ...
            value: function (A) {
              if (A >= this.fileDirectory.BitsPerSample.length) {
                throw new RangeError('Sample index '.concat(A, ' is out of range.'));
              }
                      ...
                      for (;;) {
                        switch ((A.prev = A.next)) {
                          case 0:
                            return (
                              ...
                              1 === this.planarConfiguration
                                ? (I = t * a + e)
                                : 2 === this.planarConfiguration && (I = r * a * o + t * a + e),
                              this.isTiled
                                ? ((B = this.fileDirectory.TileOffsets[I]),
                                  (c = this.fileDirectory.TileByteCounts[I]))
                                : ((B = this.fileDirectory.StripOffsets[I]),
                                  (c = this.fileDirectory.StripByteCounts[I])),
                              (A.next = 7),
                                          ...
                                          switch ((A.prev = A.next)) {
                                            ...
                                            case 2:
                                              return (
                                                (e = A.sent),
                                                (r = u.getSampleFormat()),
                                                (i = u.getBitsPerSample()),
                                                LA(r, i) &&
                                                  (e = MA(
                                                    e,
                                                    r,
                                                    u.planarConfiguration,
                                                    u.getSamplesPerPixel(),
                                                    i,
                                                    u.getTileWidth(),
                                                    u.getBlockHeight(t)
                                                  )),
                          ...
                          case 14:
                            return (
                              (A.t3 = A.sent),
                              A.abrupt('return', { x: A.t0, y: A.t1, sample: A.t2, data: A.t3 })
                            );
                          case 16:
                          case 'end':
                            return A.stop();
                        ...
                        switch ((A.prev = A.next)) {
                          case 0:
                            for (
                              ...
                              (1 === this.planarConfiguration
                                ? d.push(xA(this.fileDirectory.BitsPerSample, 0, t[p]) / 8)
                                : d.push(0),
                                w.push(this.getReaderForSample(t[p])));
                            }
                            for (D = [], k = this.littleEndian, m = Q; m < E; ++m) {
                              for (v = C; v < u; ++v) {
                                for (
                                  b = void 0,
                                    1 === this.planarConfiguration &&
                                      (b = this.getTileOrStrip(v, m, 0, i, I)),
                                    G = function (A) {
                                      var a = A,
                                        o = t[A];
                                      2 === R.planarConfiguration &&
                                        ((h = R.getSampleByteSize(o)),
                                        (b = R.getTileOrStrip(v, m, o, i, I)));
                                      var g = b.then(function (A) {
                                        for (
                                          var i = A.data,
                                            o = new DataView(i),
                                            g = R.getBlockHeight(A.y),
                                            I = A.y * B,
                                            C = A.x * s,
                                            u = I + g,
                                            Q = (A.x + 1) * s,
                                            E = w[a],
                                            y = Math.min(g, g - (u - e[3]), f - I),
                                            p = Math.min(s, s - (Q - e[2]), c - C),
                                            D = Math.max(0, e[1] - I);
                                          D < y;
                                          ++D
                                        ) {
                          ...
                          case 18:
                            ...
                            return (
                              ((F = n
                                ? RA(r, e[2] - e[0], e[3] - e[1], a, o, t.length, g)
                                : GA(r, e[2] - e[0], e[3] - e[1], a, o, g)).width = a),
                              (F.height = o),
                              A.abrupt('return', F)
                            );
                          case 23:
                        ...
                        switch ((A.prev = A.next)) {
                          case 0:
                            if (
                              ...
                              (c = e.signal),
                              !(
                                (f = t || [0, 0, this.getWidth(), this.getHeight()])[0] > f[2] ||
                                f[1] > f[3]
                              ))
                            ) {
                              A.next = 4;
                          ...
                          case 13:
                            ...
                            return A.abrupt(
                              'return',
                              Promise.reject(
                                new RangeError("Invalid sample index '".concat(n[h], "'."))
                              )
                            );
                          case 16:
                            (++h, (A.next = 13));
                          ...
                          case 19:
                            if (i) {
                              ((w = this.fileDirectory.SampleFormat
                                ? Math.max.apply(null, this.fileDirectory.SampleFormat)
                                : 1),
                                (p = Math.max.apply(null, this.fileDirectory.BitsPerSample)),
                                (d = UA(w, p, Q * n.length)),
                                B && d.fill(B));
                            } else {
                              for (d = [], D = 0; D < n.length; ++D) {
                                ((k = this.getArrayForSample(n[D], Q)),
                                  Array.isArray(B) && D < B.length
                                    ? k.fill(B[D])
                                    : B && !Array.isArray(B) && k.fill(B),
                                  d.push(k));
                              }
                            }
                            if (((A.t0 = o), A.t0)) {
                          ...
                          case 25:
                            return (
                              (m = A.t0),
                              (A.next = 28),
                              this._readRaster(f, n, d, i, m, g, I, s, c)
                            );
                          case 28:
                      ...
                      for (;;) {
                        switch ((A.prev = A.next)) {
                          ...
                          case 4:
                            ...
                            if (
                              ((u = [0, 1, 2]),
                              this.fileDirectory.ExtraSamples !== oA.Unspecified && B)
                            ) {
                              for (
                                u = [], Q = 0;
                                Q < this.fileDirectory.BitsPerSample.length;
                                Q += 1
                              ) {
                                u.push(Q);
                              }
                          ...
                          case 19:
                            return (
                              ...
                              (h = this.fileDirectory),
                              (A.next = 23),
                              this.readRasters(l)
                            );
                          case 23:
                            ((d = A.sent),
                              (w = Math.pow(2, this.fileDirectory.BitsPerSample[0])),
                              (A.t1 = C),
                              (A.next =
                                A.t1 === aA.WhiteIsZero
                                  ? 28
                          ...
                          case 41:
                            if (!n) {
                              for (
                                D = new Uint8Array(p.length / 3),
                                  k = new Uint8Array(p.length / 3),
                                  m = new Uint8Array(p.length / 3),
                                  v = 0,
                                  b = 0;
                                v < p.length;
                                v += 3, ++b
                              ) {
                                ((D[b] = p[v]), (k[b] = p[v + 1]), (m[b] = p[v + 2]));
                              }
                              p = [D, k, m];
                            }
                            return (
            ...
            value: function () {
              ...
              if (t) {
                return 0 === t[1] && 0 === t[4]
                  ? [t[0], -t[5], t[10]]
                  : [
                      Math.sqrt(t[0] * t[0] + t[4] * t[4]),
                      -Math.sqrt(t[1] * t[1] + t[5] * t[5]),
                      t[10],
                    ];
              }
              if (A) {
                ...
                return [
                  ...
                  (o * A.getHeight()) / this.getHeight(),
                  (g * A.getWidth()) / this.getWidth(),
                ];
              }
              throw new Error('The image does not have an affine transformation.');
            },
          ...
          },
          {
            ...
            value: function () {
              ...
              if (this.fileDirectory.ModelTransformation && !A) {
                ...
                return [
                  Math.min.apply(Math, D(f)),
                  Math.min.apply(Math, D(C)),
                  Math.max.apply(Math, D(f)),
                  Math.max.apply(Math, D(C)),
                ];
              }
      ...
      return (
        s(A, [
            ...
            value: function (A, e) {
              ...
              if (e) {
                if (((t = r + Math.pow(2, 32) * n), !Number.isSafeInteger(t))) {
                  throw new Error(
                    ''.concat(t, ' exceeds MAX_SAFE_INTEGER. ') +
          ...
          },
          {
            ...
            value: function (A, e) {
              for (
                var t = 0, r = (128 & this._dataView.getUint8(A + (e ? 7 : 0))) > 0, n = !0, i = 0;
                i < 8;
                i++
              ) {
                var a = this._dataView.getUint8(A + (e ? i : 7 - i));
                (r && (n ? 0 !== a && ((a = 255 & ~(a - 1)), (n = !1)) : (a = 255 & ~a)),
                  (t += a * Math.pow(256, i)));
              }
              return (r && (t = -t), t);
            },
        ...
        s(A, [
          ...
          },
          {
            ...
            value: function (A) {
              ...
              if (this._littleEndian) {
                if (((e = t + Math.pow(2, 32) * r), !Number.isSafeInteger(e))) {
                  throw new Error(
              ...
              if (((e = Math.pow(2, 32) * t + r), !Number.isSafeInteger(e))) {
                throw new Error(
                  ''.concat(e, ' exceeds MAX_SAFE_INTEGER. ') +
                    'Precision may be lost. Please report if you get this message to https://github.com/geotiffjs/geotiff.js/issues'
                );
          ...
          },
          {
            ...
            value: function (A) {
              for (
                var e = 0,
                  t = (128 & this._dataView.getUint8(A + (this._littleEndian ? 7 : 0))) > 0,
                  r = !0,
                  n = 0;
                n < 8;
                n++
        ...
        (d(this, A),
          ...
          t &&
            ...
            this._awaitingDecoder.then(function (A) {
              ...
              for (var r = 0; r < t; r++) {
                e.workers.push({ worker: A(), idle: !0 });
              }
            })));
      }
      var e;
                                ...
                                : new Promise(function (A) {
                                    ...
                                    (n.worker.addEventListener('message', function e(t) {
                                      t.data.id === i &&
                                        ((n.idle = !0),
                                        A(t.data.decoded),
                                        n.worker.removeEventListener('message', e));
                                    }),
                                      n.worker.postMessage({ fileDirectory: e, buffer: t, id: i }, [
                                        t,
                                      ]));
                                  })
                            );
  ...
  function KA(A, e) {
    ...
    if (Object.getOwnPropertySymbols) {
      ...
      for (r = 0; r < i.length; r++) {
        ((t = i[r]),
          e.indexOf(t) >= 0 || (Object.prototype.propertyIsEnumerable.call(A, t) && (n[t] = A[t])));
      }
    }
    return n;
  }
  ...
  function zA(A, e) {
    ...
    for (; t < A.byteLength; ) {
      ...
      (n.push({ headers: B, data: A.slice(Q, Q + E), offset: f, length: E, fileSize: u }),
        (t = Q + E + 4));
    }
    return n;
  }
                ...
                return y.wrap(function (A) {
                  for (;;) {
                    switch ((A.prev = A.next)) {
                      case 0:
                        throw new Error(
                          'fetching of slice '.concat(e, ' not possible, not implemented')
                        );
                      case 1:
                      case 'end':
                        return A.stop();
  ...
  var re = (function (A, e, t) {
    ...
    function n() {
      ...
      if ((d(this, n), (A = r.call(this)), !(e.maxSize && e.maxSize > 0))) {
      ...
      return (
        (A.maxSize = e.maxSize),
        (A.maxAge = e.maxAge || Number.POSITIVE_INFINITY),
        (A.onEviction = e.onEviction),
        (A.cache = new Map()),
        (A.oldCache = new Map()),
        (A._size = 0),
        A
      ...
      s(n, [
        ...
        },
        {
          ...
          value: function (A, e) {
            return (
              ...
              e.expiry <= Date.now() &&
              ('function' === typeof this.onEviction && this.onEviction(A, e.value), this.delete(A))
            );
          },
        },
        {
          ...
          value: function (A, e) {
            if (!1 === this._deleteIfExpired(A, e)) {
              return e.value;
            }
          },
        },
                ...
                for (;;) {
                  switch ((A.prev = A.next)) {
                    ...
                    case 3:
                      ...
                      if (
                        ((r = t.value), (n = a(r, 2)), (i = n[0]), (o = n[1]), this.cache.has(i))
                      ) {
                        A.next = 11;
                        break;
                      }
        ...
        },
        {
          ...
          value: function (A) {
            ...
            if (this.oldCache.has(A)) {
              ...
              if (!1 === this._deleteIfExpired(A, t)) {
        ...
        },
        {
          ...
          value: function (A, e) {
            ...
            this.cache.has(A)
              ? this.cache.set(A, { value: e, expiry: i })
              : this._set(A, { value: e, expiry: i });
          },
        },
        {
          key: 'has',
          value: function (A) {
            return this.cache.has(A)
              ? !this._deleteIfExpired(A, this.cache.get(A))
              : !!this.oldCache.has(A) && !this._deleteIfExpired(A, this.oldCache.get(A));
          },
        },
        {
          key: 'peek',
          value: function (A) {
            return this.cache.has(A)
              ? this._peek(A, this.cache)
              : this.oldCache.has(A)
                ? this._peek(A, this.oldCache)
                : void 0;
          },
        },
        {
        ...
        },
        {
          ...
          value: function (A) {
            ...
            var e = D(this._entriesAscending()),
              t = e.length - A;
            (t < 0
              ? ((this.cache = new Map(e)), (this.oldCache = new Map()), (this._size = e.length))
              : (t > 0 && this._emitEvictions(e.slice(0, t)),
                (this.oldCache = new Map(e.slice(t))),
                (this.cache = new Map()),
                (this._size = 0)),
              (this.maxSize = A));
          },
                ...
                for (;;) {
                  switch ((f.prev = f.next)) {
                    ...
                    case 23:
                      ...
                      if (
                        ((I = g.value), (s = a(I, 2)), (B = s[0]), (c = s[1]), this.cache.has(B))
                      ) {
                        f.next = 31;
                        break;
                      }
  ...
  var ce = (function (A) {
      ...
      function t(A) {
        ...
        return (
          d(this, t),
          (r = e.call(this, A)),
          Error.captureStackTrace && Error.captureStackTrace(C(r), t),
          (r.name = 'AbortError'),
          r
        );
      }
    ...
    fe = (function (A) {
      ...
      function t(A, r) {
        ...
        return (
          d(this, t),
          ((n = e.call(this, r)).errors = A),
          (n.message = r),
          (n.name = 'AggregateError'),
          n
        );
      }
      return t;
                      ...
                      for (;;) {
                        switch ((A.prev = A.next)) {
                          case 0:
                              ...
                              for (a.s(); !(o = a.n()).done; ) {
                                for (
                                  g = o.value,
                                    ...
                                    s = g.length,
                                    B = I + s,
                                    null !== (c = this.fileSize) && (B = Math.min(B, c)),
                                    f = Math.floor(I / this.blockSize) * this.blockSize,
                                    C = f;
                                  C < B;
                                  C += this.blockSize
                                ) {
                                  ((u = Math.floor(C / this.blockSize)),
                                    this.blockCache.has(u) ||
                                      this.blockRequests.has(u) ||
                                      (this.blockIdsToFetch.add(u), n.push(u)),
                                    this.blockRequests.has(u) && r.push(this.blockRequests.get(u)),
                                    i.push(u));
                                }
                              }
                            } catch (A) {
                            ...
                            return ((A.next = 8), Ie());
                          case 8:
                            for (this.fetchBlocks(t), Q = [], E = 0, l = n; E < l.length; E++) {
                              ((h = l[E]),
                                this.blockRequests.has(h) && Q.push(this.blockRequests.get(h)));
                            }
                          ...
                          case 47:
                            return (
                              (G = new Map(Be(i, v))),
                              A.abrupt('return', this.readSliceData(e, G))
                            );
                          case 49:
                          case 'end':
                            return A.stop();
                                        ...
                                        switch ((i.prev = i.next)) {
                                          ...
                                          case 14:
                                            if (
                                              ((i.prev = 14),
                                              (i.t1 = i.catch(0)),
                                              'AbortError' !== i.t1.name)
                                            ) {
                                              i.next = 22;
                                              break;
                                            }
                                            ((i.t1.signal = A),
                                              e.blockCache.delete(t),
                                              e.abortedBlockIds.add(t),
                                              (i.next = 23));
                                            break;
                                          case 22:
                                            throw i.t1;
            ...
            value: function (A) {
              ...
              try {
                for (a.s(); !(t = a.n()).done; ) {
                  ...
                  null === n || n + 1 === o
                    ? (r.push(o), (n = o))
                    : (i.push(new le(r[0] * this.blockSize, r.length * this.blockSize, r)),
                      (r = [o]),
                      (n = o));
                }
              } catch (A) {
          ...
          },
          {
            ...
            value: function (A, e) {
              ...
              return A.map(function (A) {
                ...
                for (
                  var n = Math.floor(A.offset / t.blockSize),
                    i = Math.floor(r / t.blockSize),
                    a = new ArrayBuffer(A.length),
                    o = new Uint8Array(a),
                    g = n;
                  g <= i;
                  ++g
                  ...
                  var I = e.get(g),
                    ...
                    f = void 0;
                  (s < 0 ? (B = -s) : s > 0 && (c = s),
                    (f = I.top - r < 0 ? I.length - B : r - I.offset - B));
  ...
  var Re = (function (A) {
    ...
    xe = (function (A) {
      ...
      function r(A) {
        ...
        return (
          d(this, r),
          ((e = t.call(this, A)).parsedUrl = be.parse(e.url)),
          (e.httpApi = (e.parsedUrl.protocol, be)),
          e
        );
      }
      return (
                    ...
                    for (;;) {
                      switch ((A.prev = A.next)) {
                        ...
                        case 7:
                          ...
                          if (
                            ((n = WA(r.getHeader('content-type'))),
                            (i = n.type),
                            (a = n.params),
                            'multipart/byteranges' !== i)
                          ) {
                            A.next = 18;
                            break;
                          }
                        ...
                        case 13:
                          return (
                            ...
                            (A.t2 = a.boundary),
                            (o = (0, A.t0)(A.t1, A.t2)),
                            (this._fileSize = o[0].fileSize || null),
                            A.abrupt('return', o)
                          );
                        case 18:
                        ...
                        case 20:
                          if (
                            ((g = A.sent),
                            (I = ZA(r.getHeader('content-range'))),
                            (s = I.start),
                            (B = I.end),
                            (c = I.total),
                            (this._fileSize = c || null),
                            (f = [{ data: g, offset: s, length: B - s }]),
                            !(e.length > 1))
                          ) {
                            A.next = 29;
                            break;
                        ...
                        case 36:
                          return (
                            (u = A.sent),
                            (this._fileSize = u.byteLength),
                            A.abrupt('return', [{ data: u, offset: 0, length: u.byteLength }])
                          );
                        case 39:
                        case 'end':
                          return A.stop();
                    ...
                    for (;;) {
                      switch ((A.prev = A.next)) {
                          ...
                          return (
                            ...
                            this.client.request({
                              headers: Oe(
                                Oe({}, this.headers),
                                {},
                                { Range: 'bytes='.concat(r, '-').concat(r + n) }
                              ),
                              signal: t,
                            })
                          );
                        ...
                        case 11:
                          return (
                            (a = A.sent),
                            (o = ZA(i.getHeader('content-range'))),
                            (g = o.total),
                            (this._fileSize = g || null),
                            A.abrupt('return', { data: a, offset: r, length: n })
                          );
                        case 17:
                          if (this.allowFullFile) {
                            A.next = 19;
                        ...
                        case 21:
                          return (
                            (I = A.sent),
                            (this._fileSize = I.byteLength),
                            A.abrupt('return', { data: I, offset: 0, length: I.byteLength })
                          );
                        case 24:
                        case 'end':
                          return A.stop();
  ...
  function je(A) {
    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
      ...
      r = void 0 !== t && t,
      n = KA(e, qe);
    return 'function' !== typeof fetch || r
                      ...
                      switch ((A.prev = A.next)) {
                        ...
                        case 2:
                          return (
                            (t = A.sent),
                            (A.next = 5),
                            rt(t, Buffer.alloc(e.length), 0, e.length, e.offset)
                          );
                        case 5:
  ...
  var Ct = function (A) {
          ...
          var a = (function (A, e, t, r) {
            ...
            try {
              var I = function () {
                ...
                var g = eA[i],
                  I = Bt[g];
                if (null == g || void 0 === g || void 0 === g) {
                  throw new Error('unknown type of tag: '.concat(i));
                }
                var s = r[t];
                if (void 0 === s) {
                  throw new Error('failed to get value for key '.concat(t));
                }
                  ...
                  'ASCII' === g
                    ...
                    : 'SHORT' === g
                      ...
                      : 'LONG' === g
                        ...
                        : 'RATIONAL' === g
                          ? ge(B, function (t) {
                              (A.writeUint(e, f + 8 * t, Math.round(1e4 * s[t])),
                                A.writeUint(e, f + 8 * t + 4, 1e4));
                            })
                          : 'DOUBLE' === g &&
                            ge(B, function (t) {
      ...
      for (var i = new Uint8Array(n), a = 0; a < n; a++) {
        i[a] = e[a];
      }
      return i.buffer;
    },
  ...
  function Qt(A, e) {
    var t, r, n, i;
    ('number' === typeof A[0]
      ? ((t = e.height || e.ImageLength),
        (n = e.width || e.ImageWidth),
        (r = A.length / (t * n)),
        (i = A))
      : ((r = A.length),
        (t = A[0].length),
      ...
      e.PhotometricInterpretation ||
        (e.PhotometricInterpretation = 3 === e.BitsPerSample.length ? 2 : 1),
      ...
      e.hasOwnProperty('GeographicTypeGeoKey') ||
        e.hasOwnProperty('ProjectedCSTypeGeoKey') ||
        ((e.GeographicTypeGeoKey = 4326),
        (e.ModelTiepoint = [0, 0, 0, -180, 90, 0]),
        (e.GeogCitationGeoKey = 'WGS 84'),
        (e.GTModelTypeGeoKey = 2)));
    var a = Object.keys(e)
      .filter(function (A) {
        return ae(A, 'GeoKey');
      })
        ...
        (g.push(i),
          'SHORT' === eA[i]
            ...
            : 'GeogCitationGeoKey' === A
              ? ((t = e.GeoAsciiParams.length), (r = Number(st.GeoAsciiParams)), (n = 0))
              : console.log("[geotiff.js] couldn't get TIFFTagLocation for ".concat(A)),
          g.push(r),
          g.push(t),
          g.push(n));
      }),
    ...
    var c = (function (A) {
        ...
        for (var t in A) {
          'StripOffsets' !== t &&
            (st[t] || console.error(t, 'not in name2code:', Object.keys(st)), (e[st[t]] = A[t]));
        }
        return e;
      })(e),
      f = (function (A, e, t, r) {
        if (null == t) {
          throw new Error('you passed into encodeImage a width of type '.concat(t));
        }
        if (null == e) {
          throw new Error('you passed into encodeImage a width of type '.concat(e));
        }
  ...
  function dt(A, e, t, r, n, i) {
    ...
    for (
      var o = n[0] / 8, g = 2 === i ? 1 : n.length, I = 0;
      I < r && !(I * g * t * o >= A.byteLength);
      ++I
    ) {
      var s = void 0;
      if (2 === e) {
        ...
        3 === e && ht((s = new Uint8Array(A, I * g * t * o, g * t * o)), g, o);
      }
    }
    return A;
  }
                    ...
                    for (;;) {
                      switch ((A.prev = A.next)) {
                        ...
                        case 2:
                          ...
                          return (
                            (i = !e.StripOffsets),
                            (a = i ? e.TileWidth : e.ImageWidth),
                            (o = i ? e.TileLength : e.RowsPerStrip || e.ImageLength),
                            A.abrupt(
                              'return',
                              dt(r, n, a, o, e.BitsPerSample, e.PlanarConfiguration)
                            )
                          );
                        case 9:
  ...
  function mt(A) {
    ...
    for (var t = {}, r = 4; r <= 4 * e[3]; r += 4) {
      ...
      if (i) {
        if (null == (g = A[i])) {
          throw new Error("Could not get value of geoKey '".concat(n, "'."));
        }
        'string' === typeof g
          ? (g = g.substring(o, o + a - 1))
          : g.subarray && ((g = g.subarray(o, o + a)), 1 === a && (g = g[0]));
      } else {
        g = o;
      }
      t[n] = g;
  ...
  function vt(A, e, t, r) {
    ...
    if (e !== nA.RATIONAL && e !== nA.SRATIONAL) {
      for (var o = 0; o < t; ++o) {
        n[o] = i.call(A, r + o * a);
      }
    } else {
      for (var g = 0; g < t; g += 2) {
        ((n[g] = i.call(A, r + g * a)), (n[g + 1] = i.call(A, r + (g * a + 4))));
      }
    }
  ...
  var bt = function A(e, t, r) {
      (d(this, A),
        (this.fileDirectory = e),
        (this.geoKeyDirectory = t),
        (this.nextIFDByteOffset = r));
    },
    Gt = (function (A) {
      c(t, A);
      var e = Dt(t);
                      ...
                      for (;;) {
                        switch ((A.prev = A.next)) {
                          ...
                          case 13:
                            ...
                            if (
                              (t &&
                                ...
                                (h = l[0]),
                                (d = l[1]),
                                (g = [u + t[0] * h, Q + t[1] * d, u + t[2] * h, Q + t[3] * d])),
                              (w = g || c),
                              !r)
                            ) {
                              A.next = 20;
                          ...
                          case 38:
                            ...
                            if (
                              ((S = p[G]),
                              (F = (c[2] - c[0]) / S.getWidth()),
                              (R = (c[3] - c[1]) / S.getHeight()),
                              (s = S),
                              !((i && i > F) || (o && o > R)))
                            ) {
                              A.next = 45;
                      ...
                      function (A) {
                        for (;;) {
                          switch ((A.prev = A.next)) {
                            case 0:
                              return (
                                (r = this.bigTiff ? 4048 : 1024),
                                (A.t0 = OA),
                                (A.next = 4),
                                this.source.fetch([{ offset: e, length: void 0 !== t ? t : r }])
                              );
                            case 4:
                              return (
                                (A.t1 = A.sent[0]),
                                (A.t2 = e),
                                (A.t3 = this.littleEndian),
                                (A.t4 = this.bigTiff),
                                A.abrupt('return', new A.t0(A.t1, A.t2, A.t3, A.t4))
                              );
                            case 9:
                            case 'end':
                              return A.stop();
                        ...
                        for (;;) {
                          switch ((A.prev = A.next)) {
                            ...
                            case 4:
                              if (
                                ((n = A.sent),
                                (i = this.bigTiff ? n.readUint64(e) : n.readUint16(e)),
                                (a = i * t + (this.bigTiff ? 16 : 6)),
                                n.covers(e, a))
                              ) {
                                A.next = 11;
                                break;
                            ...
                            case 14:
                              ...
                              if (
                                ((s = n.readUint16(g)),
                                (B = n.readUint16(g + 2)),
                                (c = this.bigTiff ? n.readUint64(g + 4) : n.readUint32(g + 4)),
                                (f = void 0),
                                (C = void 0),
                                (u = kt(B)),
                                (Q = g + (this.bigTiff ? 12 : 8)),
                                !(u * c <= (this.bigTiff ? 8 : 4)))
                              ) {
                                A.next = 26;
                                break;
                              }
                            ...
                            case 41:
                              return (
                                (d = mt(o)),
                                (w = n.readOffset(e + r + t * i)),
                                A.abrupt('return', new bt(o, d, w))
                              );
                            case 44:
                            case 'end':
                              return A.stop();
                        ...
                        for (;;) {
                          switch ((A.prev = A.next)) {
                            ...
                            case 4:
                              ...
                              return (
                                (this.ifdRequests[e] = this.parseFileDirectoryAt(
                                  this.firstIFDOffset
                                )),
                                      ...
                                      for (;;) {
                                        switch ((A.prev = A.next)) {
                                          ...
                                          case 5:
                                            return A.abrupt(
                                              'return',
                                              t.parseFileDirectoryAt(r.nextIFDByteOffset)
                                            );
                                          case 6:
                                          case 'end':
                                            return A.stop();
                      ...
                      function (A) {
                        for (;;) {
                          switch ((A.prev = A.next)) {
                            ...
                            case 3:
                              return (
                                (r = (t = 'GDAL_STRUCTURAL_METADATA_SIZE=').length + 100),
                                (A.next = 7),
                                this.getSlice(e, r)
                              );
                            case 7:
                              ...
                              if (
                                ((i = vt(n, nA.ASCII, r, e)),
                                (o = i.split('\n')[0]),
                                !((g = Number(o.split('=')[1].split(' ')[0]) + o.length) > r))
                              ) {
                                A.next = 16;
                                break;
                              }
                    ...
                    return y.wrap(function (A) {
                      for (;;) {
                        switch ((A.prev = A.next)) {
                          ...
                          case 2:
                            if (
                              ((n = A.sent[0]), (i = new JA(n)), 18761 !== (a = i.getUint16(0, 0)))
                            ) {
                              A.next = 9;
                              break;
                            }
                          ...
                          case 27:
                            return (
                              (s = I ? i.getUint64(8, o) : i.getUint32(4, o)),
                              A.abrupt('return', new f(e, o, I, s, t))
                            );
                          case 29:
                          case 'end':
                            return A.stop();
    ...
    Rt = (function (A) {
      ...
      function i(A, e) {
        ...
        return (
          d(this, i),
          ((t = n.call(this)).mainFile = A),
          (t.overviewFiles = e),
          (t.imageFiles = [A].concat(e)),
          (t.fileDirectoriesPerFile = null),
          (t.fileDirectoriesPerFileParsing = null),
          (t.imageCount = null),
          t
        );
      }
                    ...
                    function (A) {
                      for (;;) {
                        switch ((A.prev = A.next)) {
                          ...
                          case 3:
                            return (
                              (this.fileDirectoriesPerFile = A.sent),
                              A.abrupt('return', this.fileDirectoriesPerFile)
                            );
                          case 5:
                          case 'end':
                            return A.stop();
              ...
              switch ((A.prev = A.next)) {
                case 0:
                  return (
                    ...
                    A.abrupt('return', Ft.fromSource(je(e, t), r))
                  );
                case 3:
                case 'end':
                  return A.stop();
              ...
              switch ((A.prev = A.next)) {
                case 0:
                  return (
                    (t = n.length > 1 && void 0 !== n[1] ? n[1] : {}),
                    (r = n.length > 2 ? n[2] : void 0),
                    A.abrupt('return', Ft.fromSource(_e(e, t), r))
                  );
                case 3:
                case 'end':
                  return A.stop();
  ...
  function Kt(A) {
    for (var e = new Uint16Array(4093), t = new Uint8Array(4093), r = 0; r <= 257; r++) {
      ((e[r] = 4096), (t[r] = r));
    }
    var n = 258,
      i = 9,
    ...
    for (var c, f = new Uint8Array(A), C = g(f); 257 !== C; ) {
      if (256 === C) {
        ...
        if (C > 256) {
          throw new Error('corrupted code at scanline '.concat(C));
        }
        (Pt(B, s(C)), (c = C));
      } else if (C < n) {
        var u = s(C);
        ...
        if (!Q) {
          throw new Error(
            'Bogus entry. Not in dictionary, '.concat(c, ' / ').concat(n, ', position: ').concat(a)
          );
        }
  ...
  var jt = new Int32Array([
    ...
    tr = 2896;
  function rr(A, e) {
    for (var t = 0, r = [], n = 16; n > 0 && !A[n - 1]; ) {
      --n;
    }
    r.push({ children: [], index: 0 });
    for (var i, a = r[0], o = 0; o < n; o++) {
      for (var g = 0; g < A[o]; g++) {
        for ((a = r.pop()).children[a.index] = e[t]; a.index > 0; ) {
          a = r.pop();
        }
        for (a.index++, r.push(a); r.length <= o; ) {
          (r.push((i = { children: [], index: 0 })), (a.children[a.index] = i.children), (a = i));
        }
        t++;
      }
      o + 1 < n &&
  ...
  function nr(A, e, t, r, n, i, a, o, g) {
    ...
    function Q() {
      ...
      if (255 === (C = A[c++])) {
        var e = A[c++];
        if (e) {
          throw new Error('unexpected marker: '.concat(((C << 8) | e).toString(16)));
        }
      }
      return ((u = 7), C >>> 7);
    }
  ...
  function ir(A, e) {
    ...
    for (var I = 0; I < n; I++) {
      for (var s = I << 3, B = 0; B < 8; B++) {
        t.push(new Uint8Array(i));
      }
      for (var c = 0; c < r; c++) {
        g(e.blocks[I][c], o, a);
        for (var f = 0, C = c << 3, u = 0; u < 8; u++) {
          for (var Q = t[s + u], E = 0; E < 8; E++) {
            Q[C + E] = o[f++];
          }
        }
      }
  ...
  var ar = (function () {
            ...
            value: function (A) {
              ...
              function r(A) {
                ...
                for (t in A.components) {
                  A.components.hasOwnProperty(t) &&
                    (r < (e = A.components[t]).h && (r = e.h), n < e.v && (n = e.v));
                }
                ...
                for (t in A.components) {
                  if (A.components.hasOwnProperty(t)) {
                    e = A.components[t];
                    for (
                      var o = Math.ceil((Math.ceil(A.samplesPerLine / 8) * e.h) / r),
                        g = Math.ceil((Math.ceil(A.scanLines / 8) * e.v) / n),
                        I = i * e.h,
                        s = a * e.v,
                        B = [],
                        c = 0;
              ...
              for (a = t(); 65497 !== a; ) {
                switch (a) {
                  ...
                  case 65474:
                    ...
                    for (
                      ...
                      var E = A[e + 1] >> 4,
                        l = 15 & A[e + 1],
                        h = A[e + 2];
                      (f.componentsOrder.push(u),
                        (f.components[u] = { h: E, v: l, quantizationIdx: h }),
                        (e += 3));
                    }
                  ...
                  case 65476:
                    for (var d = t(), w = 2; w < d; ) {
                      for (var y = A[e++], p = new Uint8Array(16), D = 0, k = 0; k < 16; k++, e++) {
                        ((p[k] = A[e]), (D += p[k]));
                      }
                      for (var m = new Uint8Array(D), v = 0; v < D; v++, e++) {
                        m[v] = A[e];
                      }
                      ((w += 17 + D),
                        y >> 4 == 0
                          ? (this.huffmanTablesDC[15 & y] = rr(p, m))
                          : (this.huffmanTablesAC[15 & y] = rr(p, m)));
                    }
                    break;
                  case 65501:
                  ...
                  case 65498:
                    ...
                    for (var b = A[e++], G = [], S = this.frames[0], F = 0; F < b; F++) {
                      var R = S.components[A[e++]],
                        x = A[e++];
                      ((R.huffmanTableDC = this.huffmanTablesDC[x >> 4]),
                        (R.huffmanTableAC = this.huffmanTablesAC[15 & x]),
                        G.push(R));
                    }
                    var U = A[e++],
                      L = A[e++],
          ...
          },
          {
            ...
            value: function () {
              ...
              for (var e = 0; e < this.frames.length; e++) {
                for (
                  var t = this.frames[e].components, r = 0, n = Object.keys(t);
                  r < n.length;
                  r++
                ) {
                  var i = n[r];
                  ((t[i].quantizationTable = this.quantizationTables[t[i].quantizationIdx]),
                    delete t[i].quantizationIdx);
                }
              }
              for (
                var a = A[0],
    ...
    or = (function (A) {
      ...
      function t(A) {
        ...
        return (
          d(this, t),
          ((r = e.call(this)).reader = new ar()),
          A.JPEGTables && r.reader.parse(A.JPEGTables),
          r
        );
      }
      return (
        s(t, [
          {
            ...
            value: function (A) {
              return (
                ...
                this.reader.parse(new Uint8Array(A)),
  ...
  for (var hr = new Uint8Array(256), dr = 0; dr < 256; dr++) {
    hr[dr] = dr >= 252 ? 6 : dr >= 248 ? 5 : dr >= 240 ? 4 : dr >= 224 ? 3 : dr >= 192 ? 2 : 1;
  }
  hr[254] = hr[254] = 1;
  var wr = function (A) {
  ...
  var Dr = function () {
    ...
    Fr = function (A, e, t, r, n, i, a, o) {
      ...
      for (;;) {
        ...
        if (l > y && (v & B) !== s) {
          for (
            0 === D && (D = y), c += d, k = 1 << (p = l - D);
            p + D < w && !((k -= S[p + D]) <= 0);
          ) {
            (p++, (k <<= 1));
          }
          if (((m += 1 << p), (1 === A && m > 852) || (2 === A && m > 592))) {
            return 1;
          }
  ...
  var _r,
    ...
    An = function (A) {
      if ($r) {
        ...
        for (Fr(1, A.lens, 0, 288, _r, 0, A.work, { bits: 9 }), e = 0; e < 32; ) {
          A.lens[e++] = 5;
        }
    ...
    en = function (A, e, t, r) {
      ...
      return (
        ...
        r >= i.wsize
          ...
          : ((n = i.wsize - i.wnext) > r && (n = r),
            i.window.set(e.subarray(t - r, t - r + n), i.wnext),
            (r -= n)
              ? (i.window.set(e.subarray(t - r, t), 0), (i.wnext = r), (i.whave = i.wsize))
              : ((i.wnext += n),
    ...
    tn = {
      ...
      inflate: function (A, e) {
        ...
        A: for (;;) {
          switch (t.mode) {
            ...
            case 2:
              ...
              (t.head && (t.head.text = (I >> 8) & 1),
                512 & t.flags &&
                  ((v[0] = 255 & I), (v[1] = (I >>> 8) & 255), (t.check = cr(t.check, v, 2, 0))),
                (I = 0),
                (s = 0),
                (t.mode = 3));
            case 3:
              ...
              (t.head && (t.head.time = I),
                512 & t.flags &&
                  ((v[0] = 255 & I),
                  (v[1] = (I >>> 8) & 255),
                  (v[2] = (I >>> 16) & 255),
                  (v[3] = (I >>> 24) & 255),
                  (t.check = cr(t.check, v, 4, 0))),
                (I = 0),
                (s = 0),
                (t.mode = 4));
            case 4:
              ...
              (t.head && ((t.head.xflags = 255 & I), (t.head.os = I >> 8)),
                512 & t.flags &&
                  ((v[0] = 255 & I), (v[1] = (I >>> 8) & 255), (t.check = cr(t.check, v, 2, 0))),
                (I = 0),
                (s = 0),
            ...
            case 6:
              if (
                ...
                f &&
                  (t.head &&
                    ((y = t.head.extra_len - t.length),
                    t.head.extra || (t.head.extra = new Uint8Array(t.head.extra_len)),
                    t.head.extra.set(r.subarray(i, i + f), y)),
                  512 & t.flags && (t.check = cr(t.check, r, f, i)),
                  (o -= f),
                  (i += f),
                  (t.length -= f)),
                t.length)
            ...
            case 7:
              if (2048 & t.flags) {
                ...
                do {
                  ((y = r[i + f++]),
                    t.head && y && t.length < 65536 && (t.head.name += String.fromCharCode(y)));
                } while (y && f < o);
                if ((512 & t.flags && (t.check = cr(t.check, r, f, i)), (o -= f), (i += f), y)) {
                  break A;
                }
              } else {
            ...
            case 8:
              if (4096 & t.flags) {
                ...
                do {
                  ((y = r[i + f++]),
                    t.head && y && t.length < 65536 && (t.head.comment += String.fromCharCode(y)));
                } while (y && f < o);
                if ((512 & t.flags && (t.check = cr(t.check, r, f, i)), (o -= f), (i += f), y)) {
                  break A;
                }
            ...
            case 14:
              ...
              if (((t.length = 65535 & I), (I = 0), (s = 0), (t.mode = 15), e === Ur)) {
                break A;
              }
            case 15:
              t.mode = 16;
            case 16:
              if ((f = t.length)) {
                if ((f > o && (f = o), f > g && (f = g), 0 === f)) {
                  break A;
                }
                (n.set(r.subarray(i, i + f), a),
                  (o -= f),
                  (i += f),
                  (g -= f),
                  (a += f),
            ...
            case 18:
              ...
              if (
                ...
                (t.lenbits = 7),
                (D = { bits: t.lenbits }),
                (p = Fr(0, t.lens, 0, 19, t.lencode, 0, t.work, D)),
                (t.lenbits = D.bits),
                p)
              ) {
            ...
            case 19:
              for (; t.have < t.nlen + t.ndist; ) {
                for (
                  ;
                  (E = ((m = t.lencode[I & ((1 << t.lenbits) - 1)]) >>> 16) & 255),
                    (l = 65535 & m),
                    !((Q = m >>> 24) <= s);
                ) {
                  if (0 === o) {
              ...
              if (
                ((t.lenbits = 9),
                (D = { bits: t.lenbits }),
                (p = Fr(1, t.lens, 0, t.nlen, t.lencode, 0, t.work, D)),
                (t.lenbits = D.bits),
                p)
              ) {
              ...
              if (
                ...
                (D = { bits: t.distbits }),
                (p = Fr(2, t.lens, t.nlen, t.ndist, t.distcode, 0, t.work, D)),
                (t.distbits = D.bits),
                p)
              ) {
            ...
            case 21:
              ...
              if (E && 0 == (240 & E)) {
                for (
                  h = Q, d = E, w = l;
                  (E = ((m = t.lencode[w + ((I & ((1 << (h + d)) - 1)) >> h)]) >>> 16) & 255),
                    (l = 65535 & m),
                    !(h + (Q = m >>> 24) <= s);
                ) {
                  if (0 === o) {
            ...
            case 23:
              for (
                ;
                (E = ((m = t.distcode[I & ((1 << t.distbits) - 1)]) >>> 16) & 255),
                  (l = 65535 & m),
                  !((Q = m >>> 24) <= s);
              ) {
                if (0 === o) {
              ...
              if (0 == (240 & E)) {
                for (
                  h = Q, d = E, w = l;
                  (E = ((m = t.distcode[w + ((I & ((1 << (h + d)) - 1)) >> h)]) >>> 16) & 255),
                    (l = 65535 & m),
                    !(h + (Q = m >>> 24) <= s);
                ) {
                  if (0 === o) {
            ...
            case 25:
              ...
              if (((f = c - g), t.offset > f)) {
                ...
                (f > t.wnext ? ((f -= t.wnext), (C = t.wsize - f)) : (C = t.wnext - f),
                  f > t.length && (f = t.length),
                  (u = t.window));
              } else {
                ((u = n), (C = a - t.offset), (f = t.length));
              }
            ...
            case 27:
              if (t.wrap) {
                ...
                if (
                  ...
                  c &&
                    (A.adler = t.check =
                      t.flags ? cr(t.check, n, c, a - c) : sr(t.check, n, c, a - c)),
                  (c = g),
                  (t.flags ? I : Tr(I)) !== t.check)
                ) {
        ...
        return (
          ...
          (t.hold = I),
          (t.bits = s),
          (t.wsize || (c !== A.avail_out && t.mode < Kr && (t.mode < 27 || e !== Rr))) &&
            en(A, A.output, A.next_out, c - A.avail_out),
          (B -= A.avail_in),
          (c -= A.avail_out),
          (A.total_in += B),
          (A.total_out += c),
          ...
          t.wrap &&
            c &&
            (A.adler = t.check =
              t.flags ? cr(t.check, n, c, A.next_out - c) : sr(t.check, n, c, A.next_out - c)),
          (A.data_type =
            t.bits +
            (t.last ? 64 : 0) +
            (t.mode === Pr ? 128 : 0) +
      ...
      inflateSetDictionary: function (A, e) {
        var t,
          r = e.length;
        return A && A.state
          ? 0 !== (t = A.state).wrap && 11 !== t.mode
            ? qr
            : 11 === t.mode && sr(1, e, r, 0) !== t.check
              ? Jr
              : en(A, e, r, r)
                ? ((t.mode = 31), Or)
                : ((t.havedict = 1), Lr)
    ...
    if (
      ...
      e.dictionary &&
        ('string' === typeof e.dictionary
          ? (e.dictionary = wr(e.dictionary))
          : '[object ArrayBuffer]' === nn.call(e.dictionary) &&
            (e.dictionary = new Uint8Array(e.dictionary)),
        e.raw && (t = tn.inflateSetDictionary(this.strm, e.dictionary)) !== gn))
    ) {
      throw new Error(fr[t]);
    }
  }
  ...
  ((Cn.prototype.push = function (A, e) {
    ...
    for (
      r = e === ~~e ? e : !0 === e ? on : an,
        '[object ArrayBuffer]' === nn.call(A) ? (i.input = new Uint8Array(A)) : (i.input = A),
        i.next_in = 0,
      ...
      for (
        0 === i.avail_out && ((i.output = new Uint8Array(a)), (i.next_out = 0), (i.avail_out = a)),
          (t = tn.inflate(i, r)) === sn &&
            o &&
            ((t = tn.inflateSetDictionary(i, o)) === gn
              ? (t = tn.inflate(i, r))
              : t === cn && (t = sn));
      ...
      if (((n = i.avail_out), i.next_out && (0 === i.avail_out || t === In))) {
        if ('string' === this.options.to) {
          ...
          ((i.next_out = I),
            (i.avail_out = a - I),
            I && i.output.set(i.output.subarray(g, g + I), 0),
            this.onData(s));
        } else {
      ...
      if (t !== gn || 0 !== n) {
        if (t === In) {
          return ((t = tn.inflateEnd(this.strm)), this.onEnd(t), (this.ended = !0), !0);
        }
        if (0 === i.avail_in) {
          break;
        }
      ...
      var e,
        ...
        I =
          ((e = {
            ...
            decode: function (A, a) {
              ...
              return (
                s.resultMask && (B.maskData = s.resultMask),
                a.returnEncodedMask &&
                  g.mask &&
                  (B.encodedMaskData = g.mask.bitset ? g.mask.bitset : null),
                a.returnFileInfo &&
                  ((B.fileInfo = r(g)), a.computeUsedBitDepths && (B.fileInfo.bitDepths = n(g))),
                B
              );
            },
          }),
          (t = function (A, e, t, r, n) {
            var i,
              ...
              C = 2 * A.maxZError,
              u = Number.MAX_VALUE;
            ((t = t || (A.mask ? A.mask.bitset : null)),
              (o = new e(A.width * A.height)),
              n && t && (g = new Uint8Array(A.width * A.height)));
              ...
              if (0 !== d) {
                for (var w = 0; w <= s; w++) {
                  ...
                  if (0 !== y) {
                      ...
                      (G.encoding < 2
                        ? (0 === G.encoding
                            ...
                            : (a(
                              ...
                              (p = l)),
                          (D = 0))
                        : (k = 2 === G.encoding ? 0 : G.offset),
                      t)
                    ) {
                      for (E = 0; E < d; E++) {
                        for (7 & v && ((m = t[v >> 3]), (m <<= 7 & v)), Q = 0; Q < y; Q++) {
                          (7 & v || (m = t[v >> 3]),
                            128 & m
                              ? (g && (g[v] = 1),
                                (u = u > (i = G.encoding < 2 ? p[D++] : k) ? i : u),
                                (o[v++] = i))
                              : (g && (g[v] = 0), (o[v++] = r)),
                            (m <<= 1));
                        }
                    ...
                    if (1 === G.encoding && D !== G.numValidPixels) {
          ...
          (i = function (A, e, t) {
            ...
            if (
              ((r.fileVersion = i.getInt32(0, !0)),
              (r.imageType = i.getInt32(4, !0)),
              (r.height = i.getUint32(8, !0)),
              (r.width = i.getUint32(12, !0)),
              (r.maxZError = i.getFloat64(16, !0)),
              (e += 24),
              !t)
            ) {
              if (
                ((i = new DataView(A, e, 16)),
                (r.mask = {}),
                (r.mask.numBlocksY = i.getUint32(0, !0)),
                (r.mask.numBlocksX = i.getUint32(4, !0)),
                (r.mask.numBytes = i.getUint32(8, !0)),
                (r.mask.maxValue = i.getFloat32(12, !0)),
                (e += 16),
                r.mask.numBytes > 0)
              ) {
            ...
            ((i = new DataView(A, e, 16)),
              (r.pixels = {}),
              (r.pixels.numBlocksY = i.getUint32(0, !0)),
              (r.pixels.numBlocksX = i.getUint32(4, !0)),
              (r.pixels.numBytes = i.getUint32(8, !0)),
              (r.pixels.maxValue = i.getFloat32(12, !0)),
              (e += 16));
            ...
            for (var u = 0, Q = 0; Q < C; Q++) {
              for (var E = 0; E < f; E++) {
                ...
                r.pixels.blocks[u++] = d;
                var w = i.getUint8(0);
                if ((l++, (d.encoding = 63 & w), d.encoding > 3)) {
                  throw 'Invalid block encoding (' + d.encoding + ')';
                }
                if (2 !== d.encoding) {
                  if (0 !== w && 2 !== w) {
                    if (((w >>= 6), (d.offsetType = w), 2 === w)) {
                      ((d.offset = i.getInt8(1)), l++);
                    } else if (1 === w) {
                      ((d.offset = i.getInt16(1, !0)), (l += 2));
                    } else {
                      if (0 !== w) {
                    ...
                    if (1 === d.encoding) {
                      if (
                        ...
                        (d.bitsPerPixel = 63 & w),
                        (w >>= 6),
                        (d.numValidPixelsType = w),
                        2 === w)
                      ) {
                        ((d.numValidPixels = i.getUint8(l)), l++);
                      } else if (1 === w) {
                        ((d.numValidPixels = i.getUint16(l, !0)), (l += 2));
                      } else {
                        if (0 !== w) {
                  ...
                  if (((e += l), 3 !== d.encoding)) {
                    if (0 === d.encoding) {
                      ...
                      ((y = new ArrayBuffer(4 * p)),
                        new Uint8Array(y).set(new Uint8Array(A, e, 4 * p)));
                      var D = new Float32Array(y);
                      ((d.rawData = D), (e += 4 * p));
                    } else if (1 === d.encoding) {
                      var k = Math.ceil((d.numValidPixels * d.bitsPerPixel) / 8),
                        m = Math.ceil(k / 4);
                      ((y = new ArrayBuffer(4 * m)),
                        new Uint8Array(y).set(new Uint8Array(A, e, k)),
                        (d.stuffedData = new Uint32Array(y)),
                        (e += k));
                    }
                  }
                } else {
        ...
        s = (function () {
          var A = function (A, e, t, r, n, i, a, o) {
              ...
              if (((A[A.length - 1] <<= 8 * Q), n)) {
                for (g = 0; g < r; g++) {
                  (0 === u && ((s = A[C++]), (u = 32)),
                    u >= t
                      ? ((I = (s >>> (u - t)) & f), (u -= t))
                      : ((I = ((s & f) << (B = t - u)) & f), (I += (s = A[C++]) >>> (u = 32 - B))),
                    (e[g] = n[I]));
                }
              } else {
                for (c = Math.ceil((o - i) / a), g = 0; g < r; g++) {
                  (0 === u && ((s = A[C++]), (u = 32)),
                    u >= t
                      ? ((I = (s >>> (u - t)) & f), (u -= t))
                      : ((I = ((s & f) << (B = t - u)) & f), (I += (s = A[C++]) >>> (u = 32 - B))),
            ...
            n = function (A, e, t, r) {
              ...
              for (A[A.length - 1] <<= 8 * B, n = 0; n < r; n++) {
                (0 === s && ((a = A[I++]), (s = 32)),
                  s >= t
                    ? ((i = (a >>> (s - t)) & g), (s -= t))
                    : ((i = ((a & g) << (o = t - s)) & g), (i += (a = A[I++]) >>> (s = 32 - o))),
                  (e[n] = i));
              }
              return e;
            },
            ...
            a = {
              ...
              computeChecksumFletcher32: function (A) {
                ...
                return (
                  1 & r && (t += e += A[i] << 8),
                  (((t = (65535 & t) + (t >>> 16)) << 16) | (e = (65535 & e) + (e >>> 16))) >>> 0
                );
              },
              readHeaderInfo: function (A, e) {
                ...
                if (
                  ...
                  o >= 3 &&
                    ((i = o >= 4 ? 52 : 48),
                    this.computeChecksumFletcher32(new Uint8Array(A, t - i, n.blobSize - 14)) !==
                      n.checksum))
                ) {
              ...
              readMask: function (A, e) {
                var t,
                  ...
                  I = {};
                if (
                  ((I.numBytes = g.getUint32(0, !0)),
                  (n += 4),
                  (0 === o || a === o) && 0 !== I.numBytes)
                ) {
                  throw 'invalid mask';
                }
                if (0 === o) {
                  ...
                  do {
                    if (s > 0) {
                      ...
                      for (f = g.getUint8(B++), s = -s; s--; ) {
                        t[c++] = f;
                      }
                    }
                    ((s = g.getInt16(B, !0)), (B += 2));
                  } while (B < I.numBytes);
                  if (-32768 !== s || c < t.length) {
                    throw 'Unexpected end of mask RLE encoding';
                  }
                  r = new Uint8Array(a);
                  var C = 0,
              ...
              readDataOneSweep: function (A, e, t, r) {
                ...
                if (t === Uint8Array) {
                  n = new Uint8Array(A, i, B);
                } else {
                  var f = new ArrayBuffer(B);
                  (new Uint8Array(f).set(new Uint8Array(A, i, B)), (n = new t(f)));
                }
                if (n.length === I * g) {
                  e.pixels.resultPixels = r ? a.swapDimensionOrder(n, I, g, t, !0) : n;
                } else {
                  ...
                  if (g > 1) {
                    if (r) {
                      for (u = 0; u < I; u++) {
                        if (c[u]) {
                          for (E = u, Q = 0; Q < g; Q++, E += I) {
                            e.pixels.resultPixels[E] = n[C++];
                          }
                        }
                      }
                    } else {
                    ...
                    for (u = 0; u < I; u++) {
                      c[u] && (e.pixels.resultPixels[u] = n[C++]);
                    }
                  }
                }
              ...
              readHuffmanTree: function (A, e) {
                ...
                var s,
                  ...
                  C = [];
                for (s = i; s < g; s++) {
                  C[(B = s - (s < n ? 0 : n))] = { first: I[s - i], second: null };
                }
                ...
                var l,
                  ...
                  w = 0;
                for (l = h[0], s = i; s < g; s++) {
                  (f = C[(B = s - (s < n ? 0 : n))].first) > 0 &&
                    ((C[B].second = (l << d) >>> (32 - f)),
                    32 - d >= f
                      ? 32 === (d += f) && ((d = 0), (l = h[++w]))
                      : ((d += f - 32), (l = h[++w]), (C[B].second |= l >>> (32 - d))));
                }
                var y = 0,
                  p = 0,
                  D = new o();
                for (s = 0; s < C.length; s++) {
                  void 0 !== C[s] && (y = Math.max(y, C[s].first));
                }
                p = y >= t ? t : y;
                var k,
                  m,
                ...
                for (s = i; s < g; s++) {
                  if ((f = C[(B = s - (s < n ? 0 : n))].first) > 0) {
                    if (((k = [f, B]), f <= p)) {
                      for (m = C[B].second << (p - f), v = 1 << (p - f), c = 0; c < v; c++) {
                        S[m | c] = k;
                      }
                    } else {
                      for (m = C[B].second, G = D, b = f - 1; b >= 0; b--) {
                        ((m >>> b) & 1
                          ? (G.right || (G.right = new o()), (G = G.right))
                          : (G.left || (G.left = new o()), (G = G.left)),
                          0 !== b || G.val || (G.val = k[1]));
                      }
                    }
                  }
              ...
              readHuffman: function (A, e, t, r) {
                ...
                if (C < 2 || F) {
                  for (G = 0; G < C; G++) {
                    if (
                      (C > 1 && ((x = new t(R.buffer, E * G, E)), (b = 0)),
                      e.headerInfo.numValidPixel === Q * u)
                    ) {
                      for (c = 0, s = 0; s < u; s++) {
                        for (B = 0; B < Q; B++, c++) {
                          if (
                            ...
                            for (
                              ...
                              if (
                                !(n = (g >>> (k - f - 1)) & 1 ? n.right : n.left).left &&
                                !n.right
                              ) {
                                ((i = n.val), (p = p + f + 1));
                                break;
                ...
                ((e.ptr = e.ptr + 4 * (y + 1) + (p > 0 ? 4 : 0)),
                  (e.pixels.resultPixels = R),
                  C > 1 && !r && (e.pixels.resultPixels = a.swapDimensionOrder(R, E, C, t)));
              },
                ...
                if (h) {
                  for (
                    o.counter.lut++,
                      ...
                      D = new Uint8Array(p),
                      o.ptr += f,
                      D.set(new Uint8Array(a, o.ptr, k)),
                      b = new Uint32Array(p),
                      o.ptr += k,
                      S = 0;
                    (G - 1) >>> S;
              ...
              readTiles: function (A, e, t, r) {
                ...
                for (m = 0; m < f; m++) {
                  for (b = m !== f - 1 ? I : O, v = 0; v < c; v++) {
                    for (
                      x = m * i * I + v * I, U = i - (G = v !== c - 1 ? I : Y), w = 0;
                      w < H;
                      w++
                    ) {
                      if (
                        (H > 1
                          ? ((p = K),
                            (x = m * i * I + v * I),
                            (K = new t(e.pixels.resultPixels.buffer, g * w * B, g)),
                            (V = n.maxValues[w]))
                          : (p = null),
                      ...
                      if ((l = 3 & F) > 3) {
                        throw ((e.ptr += q), 'Invalid block encoding (' + l + ')');
                      }
                      if (2 !== l) {
                        if (0 === l) {
                          if (y) {
                          ...
                          if (
                            ...
                            (e.ptr += q),
                            (L = (L = b * G * B) < (M = A.byteLength - e.ptr) ? L : M),
                            (Q = new ArrayBuffer(L % B == 0 ? L : L + B - (L % B))),
                            new Uint8Array(Q).set(new Uint8Array(A, e.ptr, L)),
                            (E = new t(Q)),
                            (N = 0),
                            P)
                          ) {
                          ...
                          ((h = a.getDataTypeUsed(y && s < 6 ? 4 : s, R)),
                          (d = a.getOnePixel(u, q, h, C)),
                          (q += a.getDataTypeSize(h)),
                          3 === l)
                        ) {
                          if (((e.ptr += q), e.counter.constantoffset++, P)) {
                            for (D = 0; D < b; D++) {
                              for (k = 0; k < G; k++) {
                                (P[x] && (K[x] = y ? Math.min(V, p[x] + d) : d), x++);
                              }
                              x += U;
                            }
                          } else {
                ...
                H > 1 &&
                  !r &&
                  (e.pixels.resultPixels = a.swapDimensionOrder(e.pixels.resultPixels, g, H, t));
              },
            ...
            g = {
              decode: function (A, e) {
                ...
                if (o > 5) {
                  throw 'unsupported lerc version 2.' + o;
                }
                (a.readMask(A, n),
                  i.numValidPixel === i.width * i.height ||
                    n.pixels.resultMask ||
                    (n.pixels.resultMask = e.maskData));
                var I = i.width * i.height;
                ((n.pixels.resultPixels = new g(I * i.numDims)),
                  (n.counter = {
                    onesweep: 0,
                    uncompressed: 0,
                    lut: 0,
                ...
                if (0 !== i.numValidPixel) {
                  if (i.zMax === i.zMin) {
                    a.constructConstantSurface(n, B);
                  } else if (o >= 4 && a.checkMinMaxRanges(A, n)) {
                    a.constructConstantSurface(n, B);
                  } else {
                    var c = new DataView(A, n.ptr, 2),
                      f = c.getUint8(0);
                    if ((n.ptr++, f)) {
                      a.readDataOneSweep(A, n, g, B);
                    } else if (o > 1 && i.imageType <= 1 && Math.abs(i.maxZError - 0.5) < 1e-5) {
                      var C = c.getUint8(1);
                      if ((n.ptr++, (n.encodeMode = C), C > 2 || (o < 4 && C > 1))) {
                ...
                ((n.eofOffset = n.ptr),
                  e.inputOffset
                    ? ((s = n.headerInfo.blobSize + e.inputOffset - n.ptr),
                      Math.abs(s) >= 1 && (n.eofOffset = e.inputOffset + n.headerInfo.blobSize))
                    : ((s = n.headerInfo.blobSize - n.ptr),
                      Math.abs(s) >= 1 && (n.eofOffset = n.headerInfo.blobSize)));
                var u = {
                  width: i.width,
                  height: i.height,
                ...
                return (
                  (n.noDataValue = t),
                  e.returnFileInfo && (u.fileInfo = a.formatFileInfo(n)),
                  u
                );
              },
              getBandCount: function (A) {
                for (var e = 0, t = 0, r = { ptr: 0, pixels: {} }; t < A.byteLength - 58; ) {
                  (a.readHeaderInfo(A, r), (t += r.headerInfo.blobSize), e++, (r.ptr = t));
                }
                return e;
              },
            };
          ...
          decode: function (A, e) {
            ...
            for (
              ...
              var w = t.decode(A, {
                ...
                maskData: c,
                returnMask: 0 === Q,
                returnEncodedMask: 0 === Q,
                returnFileInfo: !0,
                returnPixelInterleavedDims: e.returnPixelInterleavedDims,
                pixelType: e.pixelType || null,
                noDataValue: e.noDataValue || null,
              });
              ((n = w.fileInfo.eofOffset),
                ...
                0 === Q &&
                  ...
                  (h.width = w.width),
                  (h.height = w.height),
                  (h.dimCount = w.dimCount || 1),
                  (h.pixelType = w.pixelType || w.fileInfo.pixelType),
                  (h.mask = c)),
            ...
            if (r > 1 && d > 1) {
              for (
                u = h.width * h.height, h.bandMasks = l, (c = new Uint8Array(u)).set(l[0]), f = 1;
                f < l.length;
                f++
              ) {
                for (g = l[f], C = 0; C < u; C++) {
  ...
  var Rn = new Gn(),
    xn = (function (A) {
      ...
      function t(A) {
        ...
        return (
          d(this, t),
          ((r = e.call(this)).planarConfiguration =
            void 0 !== A.PlanarConfiguration ? A.PlanarConfiguration : 1),
          (r.samplesPerPixel = void 0 !== A.SamplesPerPixel ? A.SamplesPerPixel : 1),
          (r.addCompression = A.LercParameters[gA.AddCompression]),
          r
        );
      }
      return (
        s(t, [
          {
            ...
            value: function (A) {
              switch (this.addCompression) {
                ...
                default:
                  throw new Error(
                    'Unsupported LERC additional compression method identifier: '.concat(
                      this.addCompression
                    )
                  );
              }
              return vn.decode(A, { returnPixelInterleavedDims: 1 === this.planarConfiguration })
                .pixels[0].buffer;
            },
          },
        ]),
  ...
  var Mn = (function (A) {
      ...
      function r() {
        var A;
        if ((d(this, r), (A = t.call(this)), 'undefined' === typeof createImageBitmap)) {
                        ...
                        case 3:
                          return (
                            ...
                            'undefined' !== typeof document
                              ? (((i = document.createElement('canvas')).width = n.width),
                                (i.height = n.height))
    ...
    create: function () {
      ...
      return new qn(
        'undefined' !== typeof Buffer
          ? 'data:application/javascript;base64,' + Buffer.from(A, 'binary').toString('base64')
