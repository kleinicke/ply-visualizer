...
- Name: engine/test/touch-navigation.spec.ts >> Legacy Trackball pointer input
  is replaced by stable-up touch zoom and orbit
- Location: engine/test/touch-navigation.spec.ts:179:5
