...
- Name: engine/test/touch-navigation.spec.ts >> translating two fingers together
  does not perform one-finger orbit
- Location: engine/test/touch-navigation.spec.ts:132:5
