...
- Name: engine/test/touch-navigation.spec.ts >> rotation-center feedback always
  contains only the latest red marker
- Location: engine/test/touch-navigation.spec.ts:255:5
