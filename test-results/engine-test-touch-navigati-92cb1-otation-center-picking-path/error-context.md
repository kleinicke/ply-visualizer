...
- Name: engine/test/touch-navigation.spec.ts >> one-finger double-tap uses the
  desktop rotation-center picking path
- Location: engine/test/touch-navigation.spec.ts:226:5
