...
- Name: engine/test/touch-navigation.spec.ts >> one finger orbits with fixed up
  independently of Legacy Trackball
- Location: engine/test/touch-navigation.spec.ts:59:5
